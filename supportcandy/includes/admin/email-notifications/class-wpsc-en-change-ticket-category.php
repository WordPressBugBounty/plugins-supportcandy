...
if ( ! class_exists( 'WPSC_EN_Change_Ticket_Category' ) ) :

	final class WPSC_EN_Change_Ticket_Category extends WPSC_Email_Notifications {
		 ...
		 * @var string
		 */
		private static $slug = 'change-ticket-category';
		...
		public static function init() {
			...
			// process event.
			add_action( 'wpsc_change_ticket_category', array( __CLASS__, 'process_event' ), 200, 4 );
		}
...
WPSC_EN_Change_Ticket_Category::init();
