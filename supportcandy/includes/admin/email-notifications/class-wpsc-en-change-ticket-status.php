...
if ( ! class_exists( 'WPSC_EN_Change_Ticket_Status' ) ) :

	final class WPSC_EN_Change_Ticket_Status extends WPSC_Email_Notifications {
		 ...
		 * @var string
		 */
		private static $slug = 'change-ticket-status';
		...
		public static function init() {
			...
			// process event.
			add_action( 'wpsc_change_ticket_status', array( __CLASS__, 'process_event' ), 200, 4 );
		}
...
WPSC_EN_Change_Ticket_Status::init();
