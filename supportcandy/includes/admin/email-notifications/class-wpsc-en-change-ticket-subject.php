...
if ( ! class_exists( 'WPSC_EN_Change_Ticket_Subject' ) ) :

	final class WPSC_EN_Change_Ticket_Subject extends WPSC_Email_Notifications {
		 ...
		 * @var string
		 */
		private static $slug = 'change-ticket-subject';
		...
		public static function init() {
			...
			// process event.
			add_action( 'wpsc_change_ticket_subject', array( __CLASS__, 'process_event' ), 200, 4 );
		}
		 ...
		 * @param integer     $prev - previous value.
		 * @param integer     $new - new value id.
...
WPSC_EN_Change_Ticket_Subject::init();
